...
// @author       HolynnChen modfiy by misaka10843
// @match        *://*.twitter.com/*
// @match        *://*.youtube.com/*
// @match        *://*.facebook.com/*
// @match        *://*.reddit.com/*
...
function baseTextSetter(e,name,text){//change element text
    ...
    if((text||"").length==0){
        spanNode.innerHTML = '<span style="font-size: .75em;font-weight: bold;"> <span style="display: inline-block;padding: 7px;background-color: rgb(240 29 41);border-top-left-radius: 10px;border-bottom-left-radius: 10px;color: white;">翻译异常</span> <span style="display: inline-block;padding: 7px;background-color: #EFEFEF;border-top-right-radius: 10px;border-bottom-right-radius: 10px;">请检查网络连接或稍后再试</span> </span>';
    }else{
        spanNode.innerHTML = `\n\n${show_info?'<span style="font-size: .75em;font-weight: bold;"> <span style="display: inline-block;padding: 7px;background-color: rgb(29, 155, 240);border-top-left-radius: 10px;border-bottom-left-radius: 10px;color: white;">下面为译文</span> <span style="display: inline-block;padding: 7px;background-color: #EFEFEF;border-top-right-radius: 10px;border-bottom-right-radius: 10px;">由'+name+'提供翻译支持</span> </span>':""}\n\n`+text;
    }
